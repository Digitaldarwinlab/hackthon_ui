  ...
  const computeAns = async (ans, qst, flag, index) => {
    ...
    if (crrqst.isInput) {
      ...
      if (condition) {
        ...
        let a1 = [];
        a1.push(
          `Dear ${firstname}, Based on the information you have shared and my analysis, your General score for ${part} is at ${s}%(Higher scores indicate healthier condition).`
        );
        a1.push(
          `This puts you at a ${
            scor < 40
