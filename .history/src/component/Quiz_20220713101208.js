  ...
  const computeAns = async (ans, qst) => {
    ...
    if (crrqst.isInput) {
      ...
      if (
        ...
        console.log(parseInt(localStorage.getItem("demographicLength")) +
        parseInt(localStorage.getItem("GeneralLength")) + 3 ===
      JSON.parse(localStorage.getItem("chat")).length)
        setLoading(false);
        ...
        parseInt(localStorage.getItem("demographicLength")) +
          ...
          parseInt(localStorage.getItem("FlexibilityLength")) + 3 ===
        JSON.parse(localStorage.getItem("chat")).length
      ) {
        setLoading(false);
        let a = await sendAnswers(
                ...
                <>
                  <Form>
                    <div className="question">
                      ...
                      >
                        {crransquesimg.length > 0 && crransquesimg !== undefined ? (
                          <div
                            style={{
                              display: "flex",
