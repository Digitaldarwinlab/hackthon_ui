                                    ...
                                    {finalrptLoading ? (
                                      ...
                                      <div className="card">
                                        <div className="finalskills">
                                          ...
                                          <br />
                                          <span className="finalValue">
                                            Your {part} PainScale Health Score
                                            is: {painscaleScore}%
                                          </span>
                                          <br />
                                          {chatArr.map((item, index) => (
                                      ...
                                      <div className="card-details">
                                        ...
                                        >
                                          <div className="value">
                                            ...
                                            motion range. It is an important
                                            test but can't be skipped in-between
                                            and may require you to perform some
                                            set of actions 3-4 times.
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div className="card-details">
                                      <div className="skills">
                                        <p className="value">
                                          ...
                                          {item.bmiScore} and puts you in {item.rply}
                                          .`
                                        </p>
                                        <img
                                          src={Bmi}
                                          style={{margin:'auto',marginBottom}}
                                          width={400}
                                          height={200}
                                        />
                                        <p className="value">
