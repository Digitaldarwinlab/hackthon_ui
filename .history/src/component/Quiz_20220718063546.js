                    ...
                    <>
                       ...
                       <div className="card">
                            ...
                            <div className="finalskills">
                                  ...
                                  <span className="finalValue">Dear Sushant,</span><br/>
                                  <p className="finalValue">Here is what you have shared.</p>
                                  <span className="finalValue">Your Age: 20 , Gender: Male </span><br/>
                                  <p className="finalValue">Complaint in $Joint with Pain : Pain Scale</p>
                                  <p className="finalValue">The problem Is Affecting your normal life</p>
                                  <span className="finalValue">You have difficulty in  Running/ Walking</span><br/>
                                  <p className="finalValue">The following is my observation about your Posture:</p>
                                  <p className="finalValue">I see that the deviations are High in: </p>
                                  <div className="imgcards">
                                  <img style={{margin:'auto',marginBottom:'10px'}} className='showImgs' /> 
                                  <img style={{margin:'auto',marginBottom:'10px'}} className='showImgs' /> 
                                  <img style={{margin:'auto',marginBottom:'10px'}} className='showImgs' /> 
                                  </div> <br/>
                                  
                                  <p className="finalValue">Your Flexibility for the join as per the assessment is <Near normal>, <average>, <less than average>, <better than average> (AROM)</p>
