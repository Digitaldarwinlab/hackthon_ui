                                      ...
                                      <div className="card-details">
                                        ...
                                        >
                                          <ul style={{ marginLeft: "-19px" }}>
                                            ...
                                            <li>
                                            Based on the assessment, we recommend creation of a short therapy plan for you. Please provide your acceptance for the terms and next steps. You can refer to <a
                                              href={baseUrl + "/terms"}
                                              target="_blank"
                                              rel="noopener"
                                            >
                                              Terms and Conditions
                                            </a>. We are here to help you and take you on a path of recovery and muscle strength
                                            </li>
                                          </ul>
                                        </div>
                                      </div>
