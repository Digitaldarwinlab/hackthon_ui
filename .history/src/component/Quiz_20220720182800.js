  ...
  const computeAns = async (ans, qst) => {
    ...
    if (crrqst.isInput) {
      ...
      if (
        ...
        a.push(
          `Dear ${firstname},Thank you for initiating an assesssment.I understand that you spend ${time} doing ${activity} activity. Dear ${firstname},Thank you for initiating an assesssment. I understand that you spend 8 - 12 Hrs doing Desk Job/ Sitting activity and this leads to $No Problem/ $Knee Pain/ $Shoulder Pain`
