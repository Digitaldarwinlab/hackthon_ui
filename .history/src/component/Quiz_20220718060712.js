                    ...
                    <>
                       ...
                       <div className="card">
                            ...
                            <div className="skills">
                                  ...
                                  <p className="value">Dear Sushant,</p>
                                  <p className="value">Here is what you have shared.</p>
                                  <p className="value">Your Age: , Gender : </p>
                                  <p className="value">Complaint in <$Joint> with Pain : <$Pain Scale></p>
                                  <p className="value">The problem <Is Affecting> your normal life</p>
                                  <p className="value">You have difficulty in <Climbing Stairs>, <Running/ Walking>, <Getting off chair></p>
                                  <p className="value">The problem <Is Affecting> your normal life</p>
                                  Here is what you have shared.
Your Age: , Gender : 
Complaint in <$Joint> with Pain : <$Pain Scale>
The problem <Is Affecting> your normal life
You have difficulty in <Climbing Stairs>, <Running/ Walking>, <Getting off chair>
The following is my observation about your Posture:
