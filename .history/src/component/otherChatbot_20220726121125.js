...
import Bmi from "../assets/bmi.webp";
                                    ...
                                    {rptLoading ? (
                                      ...
                                      <div className="card">
                                        <div className="card-details">
                                          ...
                                          {item.image === true && <img src={Bmi} width={400}  height={200}/> 
}
                                          {item.login === true && (
                                            <Link
                                              style={{
                                    ...
                                    {rptLoading ? (
                                      ...
                                      <div className="card">
                                        <div className="card-details">
                                          <div className="skills">
                                                <p className="value">
                                                Dear {firstname}, thank you for initiating an assessment. I understand that you spend {time} doing {activity} activity and this leads to {part} pain. Your BMI was assessed as {item.bmiScore} and puts you in {
              bmiScore < 18.5
                ? "Underweight"
                ...
                : "Extremely Obese"
                                           ...
                                           <img src={Bmi} width={400}  height={200}/> 
                                              <p className="value">We'll Like to help you with this and for muscle strengthening and conditioning to get a better understanding of your condition and design a personalized therapy schedule.</p>
                                              <p className="value">I'd Like to know a few more details which may involve performing some action on and off camera to assess your range of motion.</p>
                                          </div>
}
                                          {item.login === true && (
                                            <Link
