...
const Quiz = () => {
  ...
  const computeAns = async (ans, qst) => {
    ...
    if (crrqst.isInput) {
      ...
      let temp = {
        ...qst,
        answer: qst.section === "AromFlex"  ? qst['Excercise']  ? JSON.parse(ans): ans : ans,
        rply: randomWords[Math.floor(Math.random() * 5)],
      };
    ...
    <>
      {startAssesment === false ? (
        ...
        <>
          ...
          ></Button>
          <img src='https://i.giphy.com/media/2uJ0EhZnMAMDe/200w.webp' width={400} height={100}/>
                    ...
                    <>
                      ...
                      <div className="action">
                        ...
                        >
                          ...
                          {index + 1 === chatArr.length && item.id !== 'part' &&  item.id !== 'otp' (
                            <i
                      ...
                      {item.type === "rpt" && (
                        <div className="card">
                          <div className="card-details">
                            ...
                            {item.login === true &&(
                            <a style={{textDecoration:'none',fontSize:'15px'}} onClick={()=>{localStorage.clear()}} href='/login' target="_blank" rel="noopener noreferrer">Go to Login Page {'>>'}</a>
                            )}
                          </div>
                        </div>
                      )}
                      {item.type === "score" && (
                        ...
                        >
                          ...
                          <div className="scoreMessage">
                            <p>
                              Dear {firstname},This is the report of your issues 
                              generated by our system.
                            </p>
                            <p>
                              We'll Like to help you with it.
                            </p>
                          </div>
                        </div>
                      )}
                      {item.type === "finalrpt" && (
                        <div className="card">
                          <div className="finalskills">
                            <span className="finalValue">Dear Sushant,</span>
                            <br />
                            ...
                            <p className="finalValue">
                              The problem Is Affecting your normal life
                            </p>
                            <span className="finalValue">
                              You have difficulty in Running/ Walking
                            </span>
                            <br />
                            <p className="finalValue">
                                    ...
                                    onClick={() => {
                                      if (Array.isArray(option)) {
                                        if (option[0] === "Yes") {
                                          ...
                                          if (
                                            window.confirm("All data related to assessment will be cleared?") ===
                                            true
                                          ) {
                                            localStorage.clear()
                                            window.location.reload(false);
