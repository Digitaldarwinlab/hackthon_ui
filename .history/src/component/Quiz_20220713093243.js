  ...
  async function mainFunction() {
    let responseData = [
      ...
      },
      {
        section: "Demographic",
        part_name: "General",
        question: "Pr Email Id Please?",
        option: [["Done",1],["Do2",2],["Do3",1]],
        pp_qs_id: 9,
        type: "qst",
        isInput: true,
        id: "email",
    ...
    if (check) {
      ...
      if (check.length !== JSON.parse(localStorage.getItem("qst")).length) {
        ...
        if (a !== -1) {
          ...
          setCrransquesimg(JSON.parse(localStorage.getItem("qst"))[a+1].question_image);
          setCrransoptimg(
      ...
      setCrransquesimg(JSON.parse(localStorage.getItem("qst"))[0].question_image);
    }
  }
  ...
  const computeAns = async (ans, qst) => {
    ...
    if (crrqst.isInput) {
      ...
      setTimeout(() => {
        ...
        setCrransquesimg(JSON.parse(localStorage.getItem("qst"))[ind + 1].question_image);
      }, 3000);
    } else {
      let temp = {
        ...qst,
