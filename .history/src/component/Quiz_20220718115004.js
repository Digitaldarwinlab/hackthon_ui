                      ...
                      {item.type === "finalrpt" && (
                        <div className="card">
                          <div className="finalskills">
                            ...
                            <p className="finalValue">
                              I see that the deviations are High in:{" "}
                            </p>
                            <div className="imgcards">
                              {chatArr.map((item, index)=>(
                                <>
                                {item.section==='PostureFlex' && item.answer[0] !=='No'?(
                                  <>
                                  <img
                                  src={`${item.answer[0]}`}
                              ...
                              /></>
                                  ...
                                  <>
                                  <span>You didn't attempt the posture test</span>
                                  </>
                                )}
                                </>
                              ))}
                            ...
                            {chatArr.map((item, index)=>(
                                <>
                                {item.section==='AromFlex' && item.answer[0] !=='No'?(
                                  <>
                                  <span>Your Flexibility for the join as per the
                              assessment is better than average</span></>
                                ):(
                                  <>
                                  <span>You didn't attempt the Arom test</span>
                                  </>
                                )}
                                </>
                              ))}
