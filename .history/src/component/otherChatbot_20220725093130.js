...
const ChatBot = () => {
  ...
  const computeAns = async (ans, qst, flag, index) => {
    ...
    if (crrqst.isInput) {
      ...
      setChatArr([...chatArr, temp]);
      localStorage.setItem("chat", JSON.stringify([...chatArr, temp]));
      // let finalCondition = localStorage.getItem("index") ? parseInt(localStorage.getItem("demographicLength")) +
          ...
          parseInt(localStorage.getItem("ConsentLength")) - (parseInt(localStorage.getItem("AromFlexLength")) - 1):  JSON.parse(localStorage.getItem("chat")).length
      setLoading(true);
      ...
      if (condition) {
        ...
        parseInt(localStorage.getItem("demographicLength")) +
          ...
          parseInt(localStorage.getItem("PostureFlexLength")) +
          parseInt(localStorage.getItem("AromFlexLength")) +
          parseInt(localStorage.getItem("ConsentLength")) - (parseInt(localStorage.getItem("AromFlexLength")) - 1) ===
          JSON.parse(localStorage.getItem("chat")).length 
      ) {
        console.log(true)
        setLoading(false);
