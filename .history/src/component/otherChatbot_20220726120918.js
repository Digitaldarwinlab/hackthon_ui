                                    ...
                                    {rptLoading ? (
                                      ...
                                      <div className="card">
                                        <div className="card-details">
                                          <div className="skills">
                                                <p className="value">
                                                Dear {firstname}, thank you for initiating an assessment. I understand that you spend {time} doing {activity} activity and this leads to {part} pain. Your BMI was assessed as {itbmiScore} and puts you in ${
              bmiScore < 18.5
                ? "Underweight"
