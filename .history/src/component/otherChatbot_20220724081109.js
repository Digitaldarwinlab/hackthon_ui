...
const ChatBot = () => {
  ...
  const [generalScore, setGeneralScore] = useState(localStorage.getItem("generalScore"));
  const [painscaleScore, setPainscaleScore] = useState(localStorage.getItem("painscaleScore"));
                                    ...
                                    {finalrptLoading ? (
                                      ...
                                      <div className="card">
                                        <div className="finalskills">
                                          ...
                                          <br />
                                          <span className="finalValue">
                                          Your Knee General Health Score is: {generalScore}%
                                          </span>
                                          <br />
                                          <span className="finalValue">
                                            Your Knee General Health Score is: {painscaleScore}%
                                          </span>
                                          <br />
