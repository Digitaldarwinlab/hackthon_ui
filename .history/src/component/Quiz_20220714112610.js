                ...
                chatArr.map((item, index) => (
                  <>
                    <>
                      ...
                      {item.type === "score" && (
                        <div className="score" id={scoreHigh ? 'score-high' : scoreMild ? 'score-mild' : scoreLow ? 'score-low' : null}>
                          <div  id={scoreHigh ? 'outer-circle-high' : scoreMild ? 'outer-circle-mild' : scoreLow ? 'outer-circle-low' : null}>
