                    ...
                    <>
                       ...
                       <div className="card">
                            ...
                            <div className="skills">
                                  ...
                                  <p className="value1">Dear Sushant,</p>
                                  <p className="value1">Here is what you have shared.</p>
                                  <p className="value1">Your Age: 20 , Gender: Male </p>
                                  <p className="value1">Complaint in $Joint with Pain : Pain Scale</p>
                                  <p className="value1">The problem Is Affecting your normal life</p>
                                  <p className="value1">You have difficulty in  Running/ Walking</p>
                                  <p className="value1">The following is my observation about your Posture:</p>
