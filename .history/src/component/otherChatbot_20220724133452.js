...
const ChatBot = () => {
  ...
  const replaceText = (qst, rplTxt,flag) => {
    // console.log(qst.id);
  ...
  const computeAns = async (ans, qst,flag) => {
    let check = JSON.parse(localStorage.getItem("chat"));
    let sectionArray = [
      "General",
      "PainScale",
    ...
    if (crrqst.isInput) {
      ...
      setTimeout(() => {
        ...
        if (ind !== JSON.parse(localStorage.getItem("qst")).length - 1) {
          setCrrQst(replaceText(qst, ans,flag));
          if (flag){
            let a = parseInt(localStorage.getItem('AromFlexLength')) - 1
            setCrrAns(JSON.parse(localStorage.getItem("qst"))[ind + 1].option);
            if (JSON.parse(localStorage.getItem("qst"))[ind + 1].posture_type) {
              setCrrposterType(
                JSON.parse(localStorage.getItem("qst"))[ind + 1].posture_type
