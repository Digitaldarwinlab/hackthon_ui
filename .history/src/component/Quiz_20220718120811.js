...
const Quiz = () => {
  ...
  const computeAns = async (ans, qst) => {
    ...
    if (crrqst.isInput) {
      ...
      let temp = {
        ...qst,
        answer: qst.section === "AromFlex" ? JSON.parse(ans) : ans,
        rply: randomWords[Math.floor(Math.random() * 5)],
      };
      ...
      if (
        ...
        let a = [];
        a.push(
          `Dear ${firstname},Thank you for taking an assesssment.I understand that you spend ${time} doing ${activity} activity.This results in ${part} pains.`
        );
        a.push(
          `We'll Like to help you with it and for muscle Strengthening & conditioning`
        );
        ...
        temp.rply = 'Thank you for taking assessment with me. Your UserId and password has been send to your Email Id';
        temp.type = "rpt";
        setChatArr([...chatArr, temp]);
        localStorage.setItem("chat", JSON.stringify([...chatArr, temp]));
      }
                    ...
                    <>
                      ...
                      <div className="action">
                        ...
                        >
                          ...
                          {index + 1 === chatArr.length && chatArr.id !== 'part' (
                            <i
