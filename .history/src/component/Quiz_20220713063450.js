...
const Quiz = () => {
  ...
  async function mainFunction() {
    ...
    if (check) {
      ...
      if (JSON.parse(localStorage.getItem("qst"))[0].isInput) {
        ...
        setCrransoptimg(
          JSON.parse(localStorage.getItem("qst"))[0].option_image
        );
      }
    }
  }
  ...
  //   );
  // };
 console.log(crransemoji.length === 0 && crransemoji !== undefined)
                    ...
                    <div className="question">
                      ...
                      <div>
                        ...
                        {!(["PostureFlex", "AromFlex", "Consent"].includes(
                          ...
                          <div className="options">
                            {crransemoji.length === 0 && crransemoji !== undefined ? (
                              <>
                                <>
                              ...
                              <>
                                {crransemoji.map((option) => (
                                  <button
                                    ...
                                    key={option}
                                  >
                                    <img src={option} width="40" height="40" />
                                  </button>
                                ))}
                              </>
                            )}
