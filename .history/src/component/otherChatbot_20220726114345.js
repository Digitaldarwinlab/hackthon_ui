                                  ...
                                  <>
                                    <div className="othercard">
                                      <div className="card-details">
                                        ...
                                        >
                                          <div className="value">
                                           I will be testing your joint motion range. It is an important test but can't be skipped in-between and may require you to perform some set of actions 3-4 times.
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    {rptLoading ? (
                                      ...
                                      <div className="card">
                                        <div className="card-details">
                                          ...
                                          {item.image === true && <img src="https://images.everydayhealth.com/images/diet-nutrition/weight/bmi-in-adults-722x406.jpg?sfvrsn=9f226e4c_0" width={100}  height={100}/> 
}
                                          {item.login === true && (
                                            <Link
                                              style={{
