              ...
              bmiScore < 18.5
                ...
                : "Extremely Obese"
                                           ...
                                           <img src={Bmi} width={400}  height={200}/> 
                                              <p className="value">We'll Like to help you with this and for muscle strengthening & conditioning to get a better understanding of your condition and design a personalized therapy schedule.</p>
                                              <p className="value"></p>
                                          </div>
}
                                          {item.login === true && (
