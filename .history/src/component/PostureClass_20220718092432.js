      ...
      window.darwin.eScreenShot((id) => {
        ...
        if (id === -1) {
          ...
          if (this.state.orientCount === 1) {
            this.captureFront();
            //this.setState({ isAiStart: !this.state.isAiStart });
            const balanceAngles = await window.darwin.showAngles();
            this.setState({ balanceAngles: balanceAngles });
            ...
            this.props.setPosturePopUp(false);
            // setTimeout(() => {
            //   this.props.computeAns(
            //     {
            //       image: this.state.bodyImage,
            //       angles: this.state.balanceAngles,
            //     },
            //     this.props.question
            //   );
            // }, 1000);
