...
const Login = (props) => {
  ...
  const onFinish = async (values) => {
    ...
    if (result && result[0]) window.location.href = "/patient/schedule";
    else {
        ...
        >
          ...
          <Col span={24}>
            ...
            <Form onFinish={onFinish} layout="vertical">
              <Form.Item
                label={<span style={{ fontSize: "15px" }}>Username</span>}
                name={"username"}
              ...
              <Form.Item
                label={<span style={{ fontSize: "15px" }}>Password</span>}
                name={"Password"}
