                    ...
                    <>
                       ...
                       <div className="card">
                          <div className="card-details">
                             <div className="name">Sushant Shetty</div> 
                             <p>Here is what you have shared.</p>
                            <div className="card-about">
                              <div className="item">
                                <span className="label" style={{color:'#2D7ECB'}}>Age</span>
                                <span className="value">20</span>
                              </div>
                              <div className="item">
                                <span className="label" style={{color:'#2D7ECB'}}>Weight</span>
                                <span className="value">65 kg </span>
                              </div>
                              <div className="item">
                                <span className="label" style={{color:'#2D7ECB'}}>Height</span>
                                <span className="value">140 cm</span>
                              </div>
                            </div> 
