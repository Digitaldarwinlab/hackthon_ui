  ...
  async function mainFunction() {
    let responseData = [
      ...
      },
      {
        ...
        emoji_image: [],
        question_image: [
          "https://images.unsplash.com/photo-1649859395314-bdea587e4524?ixlib=rb-1.2.1&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80",
        ],
      },
      {
        section: "Demographic",
              ...
              {Object.keys(crrqst).length > 0 && (
                <>
                  <Form>
                    <div className="question">
                      <img className="doctor__img" src={roboDoc} alt="" />
                      <div style={{backgroundColor:'#ffff',borderRadius:'10px',padding:'2%'}}>
