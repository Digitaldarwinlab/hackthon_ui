                                        ...
                                        <div className="finalskills">
                                          ...
                                          <div className="finalValue">
                                           <div>
                                            ...
                                            Your posture deviations can be seen in the attached image and are explained in the table. 
                                            </div>
                                            <ul style={{ marginLeft: "-19px" }}>
                                            <li>
                                            Green lines indicate the ideal posture and Red lines indicate your current posture. 
                                            </li>
                                            <li>
                                            The difference is shown as the angle of deviation at certain points in the table.
                                            </li>
                                            <li>
                                            Any deviation of over 5* should be worked on for correction. 
                                            </li>
                                            <li>
                                            Posture check is a measurement at a point in time. You should ensure your posture is correct through the day and remain aligned with the green lines.
                                            </li>
                                          ...
                                          <p className="finalValue">
                                            {aromScore && (
                                              <>
                                                <div>
                                                Your {part} Join Flexibility as per the assessment is : {aromScore}{" "}
                                                </div>
                                              </>
                                            )}
                                          </p>
                                    ...
                                    <div className="othercard">
                                      <div className="card-details">
                                        ...
                                        >
                                          <ul style={{ marginLeft: "-19px" }}>
                                            <li>
                                            For any posture deviation, more than 10* and reduction in flexibility of the joint with flexibility assessed as “Impaired”, the person should seek clinical examination with a trained Physiotherapist. 
                                            </li>
                                            <li>
                                            For other categories, the person can take charge of the posture correction and increase in the strength and flexibility of the muscles by religiously following the exercise plan suggested.
                                            </li>
                                            <li>
                                            At any point in time, if any exercise leads to pain or any other discomfort in the body, you should immediately stop and seek clinical assistance.
You can schedule a TeleTherapy call with our therapist, Here. 
                                            </li>
                                            <li>
                                            Posture check is a measurement at a point in time. You should ensure your posture is correct through the day and remain aligned with the green lines.
                                            </li>
