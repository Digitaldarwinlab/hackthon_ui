...
const Quiz = () => {
  ...
  const sendAnswers = async (section, array) => {
    try {
      ...
      // console.log('Id:',id);
      const response = await fetch(
        "https://dev.physioai.care/api/submit_answer/",
        {
          method: "POST",
          headers: headers,
          body: JSON.stringify(encodedData),
  ...
  async function mainFunction() {
    let responseData;
    responseData = await getQuestions();
    // console.log(responseData);
    setTempText("dummy");
  ...
  const [otpNumber, setotpNumber] = useState(localStorage.getItem("otpNumber"));
  ...
  const otpSection = async () => {
    try {
      ...
      // console.log('Id:',id);
      const response = await fetch(
        "https://hackathon.physioai.care/api/api/verify_otp/",
        {
          method: "POST",
          headers: headers,
          body: JSON.stringify(encodedData),
      ...
      // setotpNumber()
      // localStorage.setItem("otpNumber", responseData);
      return responseData;
    } catch (err) {
      console.log(err);
      return [];
  ...
  const getOtp = async () => {
    try {
      ...
      // console.log('Id:',id);
      const response = await fetch(
        "https://hackathon.physioai.care/api/api/send_otp/",
        {
          method: "POST",
          headers: headers,
          body: JSON.stringify(encodedData),
