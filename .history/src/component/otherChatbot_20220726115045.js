...
import Bmi from "../assets/other.gif";
                                    ...
                                    {rptLoading ? (
                                      ...
                                      <div className="card">
                                        <div className="card-details">
                                          ...
                                          {item.image === true && <img src="https://images.everydayhealth.com/images/diet-nutrition/weight/bmi-in-adults-722x406.jpg?sfvrsn=9f226e4c_0" width={400}  height={200}/> 
}
                                          {item.login === true && (
                                            <Link
                                              style={{
